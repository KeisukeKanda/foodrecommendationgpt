  ...
  return (
    <header className="bg-amber-500">
      <div className='container mx-auto px-4 py-2 flex flex-wrap items-center justify-between'>
        <h1 className='text-2xl font-semibold text-zinc-900'>HealME</h1>
        <button
          ...
          <ul className="flex flex-col lg:flex-row space-y-2 lg:space-y-0 lg:space-x-8 text-lg p-4 lg:p-0">
            <li>
              <Link href="/" legacyBehavior>
                <a className="block py-1" onClick={() => setIsMenuOpen(false)}>HOME</a>
              </Link>
            </li>
            <li>
              <Link href="/about" legacyBehavior>
                <a className="block py-1" onClick={() => setIsMenuOpen(false)}>ABOUT</a>
              </Link>
            </li>
            <li>
              <Link href="/calculation" legacyBehavior>
                <a className="block py-1" onClick={() => setIsMenuOpen(false)}>CALCULATION</a>
              </Link>
            </li>
            <li>
              <Link href="/prompt" legacyBehavior>
                <a className="block py-1" onClick={() => setIsMenuOpen(false)}>PROMPT</a>
              </Link>
            </li>
          </ul>
        </nav>
