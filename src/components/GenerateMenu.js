...
const GeneratedMenu = ({ nutrientInfo, allergies, wantedIngredients }) => {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <textarea value={generatedMenu} readOnly style={{ width: "90%", height: "200px", overflow: "auto" }} />
      ...
      <textarea value={howToMake} readOnly style={{ width: "90%", height: "200px", overflow: "auto" }} />
      ...
      <textarea value={nutrientDetails} readOnly style={{ width: "90%", height: "200px", overflow: "auto" }} />
    </div>
  );
};
